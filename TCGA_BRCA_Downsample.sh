#!/bin/bash
#SBATCH --job-name=wsi_downsample          # 作业名称
...
python TCGA_BRCA_Downsample.py --input "/scratch/leuven/373/vsc37341/TCGA-BRCA/data/" --output "/scratch/leuven/373/vsc37341/TCGA-BRCA/downsampled_20x_collection" --workers 8
